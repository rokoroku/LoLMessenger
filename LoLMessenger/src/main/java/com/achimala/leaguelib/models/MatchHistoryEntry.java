...
public class MatchHistoryEntry implements PlayerList {
    ...
    public MatchHistoryEntry(TypedObject obj, LeagueSummoner primarySummoner) {
        ...
        _gameMapID = obj.getInt("gameMapId");
        _ipEarned = obj.getInt("ipEarned");
        _expEarned = obj.getInt("experienceEarned");
    ...
    public void setGameMapID(int _gameMapID) {
        this._gameMapID = _gameMapID;
    }
    
    public void setIpEarned(int _ipEarned) {
        this._ipEarned = _ipEarned;
    }

    public void setExpEarned(int _expEarned) {
        this._expEarned = _expEarned;
    }
